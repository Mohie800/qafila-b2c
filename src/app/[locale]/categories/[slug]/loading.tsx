  ...
  return (
    <div className="mx-auto max-w-360 px-4 pb-12 sm:px-6">
      ...
      <div className="mb-4 flex items-center gap-2 py-3">
        <div className="h-3 w-12 animate-pulse rounded bg-gray-light dark:bg-gray-700" />
        <div className="h-3 w-3 animate-pulse rounded bg-gray-light dark:bg-gray-700" />
        <div className="h-3 w-20 animate-pulse rounded bg-gray-light dark:bg-gray-700" />
      </div>

      {/* Header skeleton */}
      <div className="mb-4 flex items-center justify-between">
        <div>
          <div className="h-6 w-40 animate-pulse rounded bg-gray-light dark:bg-gray-700" />
      ...
      <div className="flex gap-8">
        ...
        <div className="hidden w-[240px] shrink-0 space-y-4 lg:block">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="space-y-2 border-b border-gray-border dark:border-gray-700 pb-4">
